...
def fun(equity):
  ...
  ten= f.transpose()
  p = keras.models.load_model('https://github.com/mayanknagory/NSE50/blob/main/l_ADANIENT.keras')
  ...
  p = keras.models.load_model('https://github.com/mayanknagory/NSE50/blob/main/h_ADANIENT.keras')
